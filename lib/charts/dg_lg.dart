...
// class DogLeg extends StatelessWidget {
//   final List<FlSpot> puntos;

//   const DogLeg({super.key, required this.puntos});
...
//     int maxLabels = 3; // máximo número de etiquetas visibles
//     double rawInterval = rangeX / maxLabels;

//     // función para redondear bonito (tipo 0.5, 1, 2, 5, etc.)
...
//                           },
//                         ),
//                         axisNameWidget: const Text('Indice de severidad', style: TextStyle(fontSize: 12)),
//                       ),
...
//                           },
//                         ),
//                         axisNameWidget: const Text('Profundidad Desarrollada (md)', style: TextStyle(fontSize: 12)),
//                       ),
                        ...
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            double cleanValue(double v) {
                              if (v.abs() < 0.05) return 0; // evita -0.0
                              return v;
                            }
